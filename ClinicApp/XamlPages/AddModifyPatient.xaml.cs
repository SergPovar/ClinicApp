    ...
    public partial class AddModifyPatient : Page
    {
        ...
        private async void btnSubmit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var age = dateNow.Year - dateOfBirth.Value.Year;
                if (dateOfBirth > dateNow.AddYears(-age)) age--;
                ...
                if (dateOfBirth >= DateTime.Now || age > 120)
                {
                    status = false;
                    messageBuilder.Append("Возраст должен быть больше 0 и меньше 120\n");
